...
from .views import UserViewSet, GroupViewSet, CaseViewSet, ResultViewSet, FlowViewSet, SuiteViewSet, AuthViewSet, ObtainAuthToken, AuthScript1ViewSet, PlanViewSet,UserInfoViewSet
